...
import { getAudioPlayerById } from 'apiSdk/audio-players';
import { AudioPlayerInterface } from 'interfaces/audio-player';
import { FavoriteAudioPlayersListPage } from 'pages/favorite-audio-players';

function AudioPlayerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('audio_player', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/audio-players/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Release Year" text={data?.release_year} />
