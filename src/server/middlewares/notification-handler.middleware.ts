...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'audio_player.create': { roles: ['owner'], key: 'audio-player-added', tenantPath: [], userPath: [] },
  'audio_player.delete': { roles: ['owner'], key: 'audio-player-removed', tenantPath: [], userPath: [] },
  'song.create': { roles: ['owner'], key: 'song-added', tenantPath: [], userPath: [] },
  'song.delete': { roles: ['owner'], key: 'song-removed', tenantPath: [], userPath: [] },
  'user.update': { roles: ['owner'], key: 'account-updated', tenantPath: ['organization', 'user'], userPath: [] },
};
